...
function InterviewExperienceClean() {
  ...
  const fetchInterviews = async () => {
    try {
      ...
      // Set comprehensive demo data with more companies
      setInterviews([
        {
          _id: "1",
        ...
        },
        {
          ...
          experience: "Wipro interview process included online assessment, technical interview, and HR discussion. The focus was on programming fundamentals and problem-solving skills.",
          interviewLevel: "easy",
          result: "Successful",
          date: "2024-01-15",
          likes: 20,
        ...
        },
        {
          ...
          position: "Software Engineer",
          experience: "HCL interview covered technical skills, aptitude test, and personal interview. The process was systematic and focused on both technical and soft skills.",
          interviewLevel: "medium",
          result: "Successful",
          date: "2024-01-12",
          likes: 24,
        ...
        },
        {
          ...
          position: "Consultant",
          experience: "Capgemini interview process was comprehensive with multiple rounds including technical assessment, group discussion, and personal interview. Good focus on analytical skills.",
          interviewLevel: "medium",
          result: "Successful",
          date: "2024-01-10",
          likes: 26,
        ...
        },
        {
          ...
          experience: "Cognizant interview included coding assessment, technical interview, and HR round. The focus was on programming skills and problem-solving abilities.",
          interviewLevel: "easy",
          result: "Successful",
          date: "2024-01-08",
          likes: 19,
        ...
        {
          _id: "15",
          username: "Rashmi Patel",
          companyName: "Accenture",
          position: "Software Developer",
          experience: "Accenture interview process was well-structured with technical rounds, behavioral assessment, and case study discussions. Good emphasis on innovation and teamwork.",
          interviewLevel: "medium",
          result: "Successful",
          date: "2024-01-05",
          likes: 28,
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ flexGrow: 1, bgcolor: 'background.default', minHeight: '100vh' }}>
        ...
        <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
          ...
          {/* Search Bar with Company Suggestions */}
          <Paper
            elevation={3}
            sx={{
              p: 3,
          ...
          >
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, justifyContent: 'center' }}>
              ...
              {['Google', 'Microsoft', 'Amazon', 'Apple', 'Meta', 'TCS', 'Infosys', 'Wipro'].map((company) => (
                <Chip
                  key={company}
                  label={company}
                  size="small"
...
export default InterviewExperienceClean;
